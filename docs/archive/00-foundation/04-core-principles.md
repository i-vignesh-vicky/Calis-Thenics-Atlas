...
Define non-negotiable principles that guide product, engineering, design, and AI decisions.

## Principles

1. Solve user problems, not checklists.
2. Prioritize progress over raw activity volume.
3. Reward consistency over intensity spikes.
4. Keep users in control; AI advises, users decide.
5. Build trust before optimizing engagement.
6. Reduce friction in core habit loops.
7. Keep complexity progressive, not default.
8. Preserve one source of truth for critical data.
9. Build for long-term maintainability and evolution.
10. Ground guidance in evidence, not trends.
11. Personalize by context, not generic templates.
12. Collect only data that enables clear user value.
13. Reward contribution and mentorship in community systems.
